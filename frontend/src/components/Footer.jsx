  ...
  <>
    ...
    <footer className="w-full bg-white p-8 dark:bg-gray-800 dark:text-white">
      ...
      <div className="flex items-center justify-around text-xl font-semibold tracking-wide">
        ...
        <a className="relative text-blue-500 after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-full after:origin-left after:scale-x-0 after:bg-blue-500 after:transition-transform after:duration-300 hover:after:scale-x-100" href="https://github.com/Yuranium">Yuranium</a>
      </div>
    </footer>
  </>
  );
